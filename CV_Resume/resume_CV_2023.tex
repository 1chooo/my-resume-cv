...
\section{\textbf{Extracurricular Activity}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {APP developer team for all the members at NCU.}{Mar. 2023 - present}
      \vspace{-1.0mm}
      \resumeItemListStart
        \item {The crucial experience of manage existing projects with teammates to make the functions more completely.}
        \item {Frontend skills: React Native, UI/UX, Figma.}
        \item {Marketing: product listings, map functionality.}
      \resumeItemListEnd
    \vspace{-3.0mm}
...
%     \resumeSubheading
%       {TOEIC 690}{}
%       {Listening: 355;Reading: 335}{Mar. 2023}
%   \resumeSubHeadingListEnd
...
\resumePOR{TOEIC 690 } % Award
    {Listening: 355; Reading: 335} % Event
    {Mar. 2023} %Event Year
