...
\section{\textcolor{olive}{\textbf{Professional Experience}}}
    \resumeSubHeadingListStart
        \resumeSubheading
            { Cloud Ambassador, Amazon Web Services (AWS) | \textcolor{gray}{\small{\faMapMarker}} \textcolor{gray}{\small{Taipei, Taiwan}}}
            {}
            {}
            {Aug. 2023 - present}
        ...
        \resumeSubheading
            { Software Engineer Intern, Pegatron Corporation | \textcolor{gray}{\small{\faMapMarker}} \textcolor{gray}{\small{Taipei, Taiwan}}}
            {}
            {}
            {Jul. 2023 - Aug. 2023}
        ...
        \resumeSubheading
            { Website Administrator, National Central University | \textcolor{gray}{\small{\faMapMarker}} \textcolor{gray}{\small{Taoyuan, Taiwan}}}
            {}
            {}
            {Jul. 2022 - Jan. 2023}
