...
\section{\textcolor{olive}{\textbf{Professional Experience}}}
    \resumeSubHeadingListStart
        \resumeSubheading
            ...
            \resumeItemListStart
                \item {Lead 4 workshops, 1 UAD within up to \textbf{500 attendees}, and build 2 open-source projects.}
                \item {Build AWS 101 LINE Bot with AWS lambda, s3, API Gateway and be used in AWS 101.}
                \item {Technical Support in Marketing Program aids MKT members' tech comprehension.}
            \resumeItemListEnd
