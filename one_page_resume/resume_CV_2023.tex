...
\section{\textcolor{olive}{\textbf{Extracurricular Activity}}}
    \resumeSubHeadingListStart
        \resumeSubheading
            { NCUFresh Team (NCUBlog)
                \hspace{0.5em} 
                \href{https://github.com/ncufresh}{\faGithub} 
                \hspace{0.2em} 
                \href{https://22.ncufresh.ncu.edu.tw/blog/}{\faDesktop}
            } 
            {}%Project Name
        ...
        \resumeSubheading
            { NCUApp Team (UI/UX \& Marketing)
                \hspace{0.5em} 
                \href{https://github.com/NCUAppTeam}{\faGithub} 
                \hspace{0.2em} 
                \href{https://ncuappteam.github.io/}{\faDesktop}
            } 
            {}%Project Name
    ...
    \resumeSubHeadingListStart
        \resumeProject
            { SIMPLE AI: Multi-User Machine Learning Education Platform 
                ...
                \hspace{0.2em} 
                \href{https://www.youtube.com/watch?v=S0HZJIqVThI}{\faDesktop}
            } %Project Name
